...
export default function CalendarPage() {
  ...
  const fetchEvents = async () => {
    try {
      ...
      // Mock data for demo
      setEvents([
        { id: 1, title: 'Annual Leave', date: '2024-12-15', type: 'leave', employee_name: 'John Doe', leave_type: 'ANNUAL' },
        { id: 2, title: 'Christmas Day', date: '2024-12-25', type: 'holiday' },
        { id: 3, title: 'Sick Leave', date: '2024-12-10', type: 'leave', employee_name: 'Jane Smith', leave_type: 'SICK' },
        { id: 4, title: 'Team Meeting', date: '2024-12-20', type: 'team' },
        { id: 5, title: 'New Year', date: '2025-01-01', type: 'holiday' },
      ]);
    } finally {
      setIsLoading(false);
    }
